   ...
   vm = new Vue({
       ...
       methods:{
           showData:function (prarm) {
               postUtil.call('/statistics/getProductListPageData', prarm, function (pageResult) {
               ...
               postUtil.call('/statistics/getAllProductData', prarm, function (pageResult) {
                   if(pageResult.success == true){
           ...
           exportData:function () {
               postUtil.submit("/statistics/paroductsales/exportExcel",this.queryParam, function (res) {
                   layer.msg("导出成功");
               })
           },
           echarts:function (data) {
               ...
               $.each(data.data,function (index,item) {
                   vm.echartsName.push(item.skuName);
                   vm.echartsList.push({
