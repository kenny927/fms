...
;!function () {
    ...
    f.on = function (a, b, c) {
        ...
        return c.pages > c.groups && e.end < c.pages && c.last && 0 !== c.groups && d.push('<span>&#x2026;</span><a href="javascript:;" class="laypage_last" title="&#x5C3E;&#x9875;"  data-page="' + c.pages + '">' + c.last + "</a>"), e.flow = !c.prev && 0 === c.groups, (c.curr !== c.pages && c.next || e.flow) && d.push(function () {
            ...
            }(c.skin) : "default") + '" id="laypage_' + b.config.item + '">' + '<span class="layPage_pageInfo">&#x603b;'+c.pages+'&#x9875;&#x2f;'+c.total+'&#x6761;&#x8bb0;&#x5f55;</span>' + d.join("") + function () {
            return c.skip ? '<span class="laypage_total"><label>&#x8df3;&#x8f6c;&#x5230;&#x7B2C;</label><input type="number" min="1" onkeyup="this.value=this.value.replace(/\\D/, \'\');" class="laypage_skip"><label>&#x9875;</label><button type="button" class="laypage_btn">&#x8df3;&#x8f6c;</button></span>' : ""
        }() + "</div>"
